...
function ltable = calculate_likelihood_sym(C, Q, E, theta)
...
function s = draw_muts(c, theta)
delta = .5;
pdf = @(x) probfix2(c,x, theta);
...
% text).
function prob = probfix2(c,x, theta)
n =  2.3*10^6;
